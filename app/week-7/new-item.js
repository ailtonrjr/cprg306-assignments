...
export default function Counter({ onAddItem }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-96 h-1/3 bg-slate-800 justify-stretch gap-10">
        <div className="flex flex-row items-center justify-center w-2/5 h-5/6 bg-white rounded-md m-2">
          <p className="text-1x1 text-gray-900 w-4/5 bg-white h-10 rounded-md p-2 flex justify-center items-center">
            {count}
          </p>
          <button
